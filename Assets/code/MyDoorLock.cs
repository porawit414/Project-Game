...
public class MyDoorLock : MonoBehaviour
{
    ...
    [Header("ผี Jumpscare")]
    public GameObject ghostlyWoman; // <--- เพิ่มช่องนี้สำหรับใส่ตัวผี
    ...
    void Start()
    {
        ...
        // ซ่อนผีไว้ตอนเริ่มเกมโดยอัตโนมัติ (เผื่อคุณลืมซ่อนในหน้าต่าง Scene)
    ...
    void TryOpenDoor()
    {
        ...
        if (player != null)
        {
            ...
            {
                // ไม่มีกุญแจ -> โชว์ข้อความแจ้งเตือน (ผีจะไม่ออกมา)
    ...
    void OpenDoor()
    {
        ...
        // โผล่ผีออกมาเมื่อเปิดประตูสำเร็จ!
        if (ghostlyWoman != null)
        {
            ghostlyWoman.SetActive(true);
        }
